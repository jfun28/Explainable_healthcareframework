...
def main():
    ...
    for generation in Generation_list:
        ...
        # 3. 모델 저장
        model_save_path = path+f'\\3_1.Training_XAI\\model_hist\\{generation}_proposed_tabnetEmbedd.pickle'
        ...
        # 8. 스케일러 저장
        scaler_save_path = path+f'\\3_1.Training_XAI\\scaler_hist\\{generation}_proposed_standard_scaler.pickle'
        ...
        # 11. XGBoost 모델 저장
        xgb_save_path = path+f'\\3_1.Training_XAI\\model_hist\\{generation}_proposed.pickle'
